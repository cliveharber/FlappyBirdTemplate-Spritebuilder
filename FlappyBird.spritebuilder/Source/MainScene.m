...
- (void)addObstacle {
    ...
    CGPoint worldPosition = [self convertToWorldSpace:ccp(380, 0)];
    CGPoint screenPosition = [physicsNode convertToNodeSpace:worldPosition];
    obstacle.position = screenPosition;
